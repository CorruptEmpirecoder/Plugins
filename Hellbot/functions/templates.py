...
PING_TEMPLATES = [
    ...
    ⚘  **𝙱𝙸𝙻𝙻𝙸 𝚂𝙿𝙴𝙴𝙳:** {speed} m/s
    ⚘  **𝙱𝙸𝙻𝙻𝙸 𝚄𝙿𝚃𝙸𝙼𝙴:** {uptime}
    ⚘  **𝙱𝙸𝙻𝙻𝙸 𝙾𝚆𝙽𝙴𝚁:** {owner}""",
]

HELP_MENU_TEMPLATES = [
    """**🐈BILLI HELP MENU FOR:** {owner}
...
COMMAND_MENU_TEMPLATES = [
    """**Billi 𝖯𝗅𝗎𝗀𝗂𝗇 𝖥𝗂𝗅𝖾:** `{file}`
**Billi 𝖯𝗅𝗎𝗀𝗂𝗇 𝖨𝗇𝖿𝗈:** __{info} 🍀__
...
╭──────── {gtype} ────────•
╰➢ **𝙱𝚒𝚕𝚕𝚒 𝚟𝚒𝚌𝚝𝚒𝚖:** {name}
╰➢ **𝙱𝚒𝚕𝚕𝚒 𝙶𝚋𝚊𝚗 𝚂𝚞𝚌𝚌𝚎𝚜𝚜:** {success}
╰➢ **𝙱𝚒𝚕𝚕𝚒 𝙶𝚋𝚊𝚗 𝙵𝚊𝚒𝚕:** {failed}
╰➢ **𝙱𝚒𝚕𝚕𝚒 𝙶𝚋𝚊𝚗 𝚁𝚎𝚊𝚊𝚜𝚘𝚗:** {reason}
╰────────────────•
"""
]
...
USER_INFO_TEMPLATES = [
    """
**🐈Billi 𝖴𝗌𝖾𝗋 𝖨𝗇𝖿𝗈 𝗈𝖿 {mention}:**

**➢ Billi 𝖥𝗂𝗋𝗌𝗍 𝖭𝖺𝗆𝖾:** `{firstName}`
**➢ Billi 𝖫𝖺𝗌𝗍 𝖭𝖺𝗆𝖾:** `{lastName}`
**➢ Billi 𝖴𝗌𝖾𝗋𝖨𝖣:** `{userId}`

**➢ Billi 𝖢𝗈𝗆𝗆𝗈𝗇 𝖦𝗋𝗈𝗎𝗉𝗌:** `{commonGroups}`
**➢ Billi 𝖣𝖢-𝖨𝖣:** `{dcId}`
**➢ Billi 𝖯𝗂𝖼𝗍𝗎𝗋𝖾𝗌:** `{totalPictures}`
**➢ Billi 𝖱𝖾𝗌𝗍𝗋𝗂𝖼𝗍𝖾𝖽:** `{isRestricted}`
**➢ Billi 𝖵𝖾𝗋𝗂𝖿𝗂𝖾𝖽:** `{isVerified}`
**➢ Billi 𝖡𝗈𝗍:** `{isBot}`
**➢ Billi 𝖡𝗂𝗈:** `{bio}`
...
**➢ Billi 𝖢𝗁𝖺𝗍 𝖭𝖺𝗆𝖾:** `{chatName}`
**➢ Billi 𝖢𝗁𝖺𝗍 𝖨𝖣:** `{chatId}`
**➢ Billi 𝖢𝗁𝖺𝗍 𝖫𝗂𝗇𝗄:** {chatLink}
**➢ Billi Chat 𝖮𝗐𝗇𝖾𝗋:** {chatOwner}
**➢ Billi 𝖣𝖢-𝖨𝖣:** `{dcId}`
**➢ Billi Chat 𝖬𝖾𝗆𝖻𝖾𝗋𝗌:** `{membersCount}`
**➢ Billi Chat 𝖠𝖽𝗆𝗂𝗇𝗌:** `{adminsCount}`
**➢ Billi 𝖡𝗈𝗍𝗌 In Chat:** `{botsCount}`
**➢ Billi Chat 𝖣𝖾𝗌𝖼𝗋𝗂𝗉𝗍𝗂𝗈𝗇:** `{description}`
